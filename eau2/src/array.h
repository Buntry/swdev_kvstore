...
/**
 * @brief This is an Array class for Objects.
 * It has O(1) push back and access time. It also splits
 * its data into chunks so that it never copies its payload.
 *
...
public:
  ...
  Array() : Object() {
    ...
    elements_ = new Object **[num_chunks_];
    elements_[0] = new Object *[capacity_];
  }
  ...
  virtual void _resize_to_(size_t new_capacity) {
    ...
    Object ***new_elements = new Object **[new_num_chunks];
    for (size_t i = 0; i < num_chunks_; i++) {
      if (i < new_num_chunks) {
    ...
    for (size_t i = num_chunks_; i < new_num_chunks; i++) {
      new_elements[i] = new Object *[CHUNK_SIZE];
    }
  ...
  virtual void push_back(Object *e) { add(num_elements_, e); }

  // Inserts e at index i
  virtual void add(size_t index, Object *e) {
  ...
  virtual void concat(Array *c) { add_all(num_elements_, c); }

  // Inserts all of elements in c into this array at index i
  virtual void add_all(size_t index, Array *c) {
    size_t len = c->size();
  ...
  virtual bool equals(Object *o) {
    Array *that = dynamic_cast<Array *>(o);
    if (that == nullptr)
      return false;
  ...
  virtual Object *set(size_t index, Object *e) {
    Object *old = get(index);
    elements_[_row(index)][_col(index)] = e;
    return old;
  }
...
public:
  ...
  // Returns the element at index
  virtual bool get(size_t index) { return elements_[_row(index)][_col(index)]; }
